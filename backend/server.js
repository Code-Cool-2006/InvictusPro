...
// Open CORS for truly public API routes (no auth required, any origin)
app.use("/api/activities/public", cors());

// Restricted CORS for all other routes — only allow the frontend origin
app.use(cors({
